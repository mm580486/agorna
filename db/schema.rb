...
ActiveRecord::Schema.define(version: 20170826080914) do
  ...
  create_table "marketer_tasks", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "user_two"
    t.string   "message"
    t.datetime "created_at", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "updated_at",                             null: false
    t.string   "date"
    t.string   "national_card_image"
    t.string   "business_license_image"
    t.string   "family"
    t.string   "gender"
  end
